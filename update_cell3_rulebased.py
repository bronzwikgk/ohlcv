...
new_code = """# Cell 3: Extracting and Plotting 21-Day Blocks (Rule-Based Zoning)
BLOCK_SIZE = 21
...
display(HTML("<h3>Block Extraction Summary (Rule-Based Zoning)</h3>"))
display(summary_df)

def plot_25_samples_rulebased(block_list, title):
    ...
    # Define Rule-Based Boundaries dynamically based on medians of the sample
    ...
    # 0=Green, 1=Blue, 2=Orange, 3=Red, 4=Purple
    ...
    # Scatter Plot with Zones marked
...
plot_25_samples_rulebased(blocks_34, "Omega 34 > 50")
plot_25_samples_rulebased(blocks_21, "Omega 21 > 50")
"""
